...
if (t) {
  ...
  console.log("/missing:", r1.status, "total:", j1.total, "page:", j1.page, "records:", j1.missing?.length, r1.ok ? "OK" : JSON.stringify(j1));
  ...
  console.log("/diff:", r2.status, "diffs:", j2.differences?.length, "page:", j2.page, r2.ok ? "OK" : JSON.stringify(j2));
  ...
  console.timeEnd("all");
  console.log("/all:", r3.status, "records:", j3.records?.length, "total:", j3.total, r3.ok ? "OK" : JSON.stringify(j3));
}
